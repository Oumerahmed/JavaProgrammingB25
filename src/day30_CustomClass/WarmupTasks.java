...
public class WarmupTasks {
    public static void main(String[] args) {
        ...
        Collections.swap(numbers,0,numbers.size()-1); // swiche number 1 by 8
        ...
        int totalNumbersofZeros = size-newSize;


        System.out.println("totalNumbersofZeros = " + totalNumbersofZeros);


        for (int i = 0; i<totalNumbersofZeros;i++){
            list.add(0);
